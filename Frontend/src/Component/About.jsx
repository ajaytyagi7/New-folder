...
const About = () => {
  return (
    <div className='container-fluid  p-5'>
        <div className='row mb-4 mt-3'style={{gap:10}}>
            ...
            <div className='col card'>
              <img src="https://img.freepik.com/free-photo/medium-shot-woman-working-laptop_23-2149300643.jpg?w=996&t=st=1708099972~exp=1708100572~hmac=5aff53ae2c98fa77a1902c3406880fcbfad518718720d2eea042e3c5a54d017a" alt="" />
            </div>
        </div>

        <div className='row' style={{gap:10}}>
          <h3 className='text-center fw-bold mb-3'>Our Team</h3>
          <div className='col card rounded-pill'>
              <img className='rounded-pill' src="https://img.freepik.com/free-photo/mand-holding-cup_1258-340.jpg?w=996&t=st=1708100312~exp=1708100912~hmac=d5a32c43998bd4657cec8959d9d1b9886a5040096c1b8521ba916fcbe988f2b4" alt="" />
          </div>
          <div className='col card rounded-pill'>
        ...
        <div className='card p-3 mt-5 bg-dark-subtle '>
          ...
          <p className='fw-bold'>Welcome to  OffBeatCampus, where we believe in connecting talent with opportunity to create a brighter future. With a passion for fostering career growth and building strong professional relationships, we are committed to being a trusted partner in your job search journey.
            ...
            At  OffBeatCampus, we understand the dynamic landscape of the job market and the evolving needs of both employers and job seekers. Our mission is to bridge the gap between exceptional talent and forward-thinking companies, creating mutually beneficial partnerships that drive success.

            With a team of dedicated professionals, OffBeatCampus is committed to providing unparalleled service and support throughout the entire recruitment process. Whether you are a candidate seeking new opportunities or an employer looking for the perfect fit, we are here to guide you with expertise and integrity.

            Why choose  OffBeatCampus?

            Expertise: Our team brings years of experience and industry knowledge to the table, ensuring that we understand the unique requirements of each job placement.

            Personalized Approach: We recognize that every individual and company is unique. That's why we tailor our services to meet your specific needs, fostering connections that last.

            Innovation: Embracing the latest trends and technologies, we stay ahead of the curve to provide cutting-edge solutions for both job seekers and employers.

            Ethical Practices: Integrity is at the core of everything we do. We uphold the highest ethical standards, ensuring transparency, honesty, and fairness in all our interactions.

            Join us at  OffBeatCampus, where your career aspirations meet endless possibilities. Let's embark on a journey together, unlocking the doors to your professional success.</p>
        </div>
    </div>
  )
}
